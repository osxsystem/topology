...
| [0010](0010-packaging-distribution.md) | 0010 — Packaging & distribution: system-PATH binary, CI mirrors the justfile, hand-authored plugin | Accepted, amended by 0015 |
| [0011](0011-prebuilt-binary-distribution.md) | 0011 — Prebuilt-first binary distribution: release matrix, installer download, plugin self-provisioning | Accepted, amended by 0015 |
